 ...
 * @author diana
 */
public class Picture extends javax.swing.JDialog {

    /**
     * Creates new form Picture
     */
    public Picture(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Picture dialog = new Picture(new javax.swing.JFrame(), true);
